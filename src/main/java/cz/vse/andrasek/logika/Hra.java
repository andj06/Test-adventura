...
public class Hra implements IHra {
    ...
    public Hra() {
        ...
        platnePrikazy.vlozPrikaz(new PrikazRozhlidni(herniPlan));
    ...
    public String vratUvitani() {
        return "Vítejte!\n" +
               "Království Bohertem stíhá smrtelný mor a chrabrý Wiliam se rozhodne zakročit.\n" +
                "Hraješ za mladého Wiliama, učně mistra kováře. Vzal sis sebou meč a štít a jsi připravený vyrazit.\n" +
